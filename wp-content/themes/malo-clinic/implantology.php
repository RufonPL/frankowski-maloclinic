...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12 col-md-6 owner-item">
            ...
            <div class="owner_details">
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <div class="owner_details_p"><?php the_field('owner_details');?></p></div>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-6 owner-item">
            <div class="owner_title">
                <h2 class="owner_header"><?php  the_field('owner_name_2');?></h2>
                <p class="owner_subheader"><?php the_field('owner_subheader_2');?></p>
            </div>
            <div class="owner_pic">
                <img class="img_owner" src="<?php echo the_field('img_owner_2');?>" />
            </div>
            <div class="owner_details">
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <div class="owner_details_p"><?php the_field('owner_details_2');?></p></div>
                </div>
            </div>
        </div>
    </div>
